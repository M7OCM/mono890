...
- chirp-next-m7ocm-evolution-x-r2.py (full feature set only available on r2 and later firmware)
...
*Update 23 September 26, this is now fixed in Revision 3 firmware (r3), just testing before release - M7OCM*
